  ...
  return (
    <section className="relative min-h-[92svh] w-full overflow-hidden bg-[#0b0c10]">
      <div className="relative z-10 flex min-h-[92svh] flex-col">
        ...
        <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col items-center gap-8 px-5 py-8 sm:py-12 lg:flex-row lg:gap-16">
          <div className="max-w-xl text-center lg:text-left lg:max-w-[44%]">
            <p className="text-[11px] uppercase tracking-[0.25em] text-white/40">
              for students done doing this by hand
            </p>
            <h1 className="mt-5 font-display text-4xl font-semibold leading-[1.03] tracking-tight sm:text-5xl lg:text-7xl">
              Pick the job.
